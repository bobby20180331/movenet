...
python test.py single_pose --exp_id pet17kp --dataset active --arch movenet --resume

python test.py single_pose --exp_id pet17kp_movenet --dataset active --arch movenet --load_model ../models/model_pet17kpbe100.pth
cd ..